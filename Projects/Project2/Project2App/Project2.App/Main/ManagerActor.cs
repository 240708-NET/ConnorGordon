...
namespace Project2.App.Main {
    public class ManagerActor {
        ...
        private async void AddEnemies() {
            ...
            string str = client.GetStringAsync("http://localhost:5262/getAllEnemies").Result;
            ...
            if (tempDict.Count == 0) {
                ...
                var postResponse = await client.PostAsync("http://localhost:5262/createAllEnemies", enemies);
